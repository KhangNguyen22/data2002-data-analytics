...
$\lambda = \frac{\sum(colu)}{n}$ where **n** is the total number of observations.
...
Figure 2 bar chart visualises the data in figure 1. We will use the figure 1 to calculate $\lambda$.
