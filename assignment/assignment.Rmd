...
# clean_df[is.na(clean_df$postcode)==TRUE,]
# head(clean_df[1])
...
In
We cleaned only the columns in which we will use for our data analysis.
Only the following columns were cleaned.

3 paragraphs to explain what was cleaned.

Removed 2 useless rows
